...
from django.utils import timezone # Pour utiliser timezone.now
...
class Ticket(models.Model):
    ...
    email = models.EmailField(max_length=255) # Django a un champ spécifique pour les e-mails
    subject = models.CharField(max_length=100)
    message = models.TextField()
    submission_date = models.DateTimeField(default=timezone.now) # Utilise la date et l'heure actuelles avec le fuseau horaire
    platform_name = models.CharField(max_length=100)
    status = models.CharField(max_length=50, default='nouveau') # Statut par défaut "nouveau"
    priority = models.CharField(max_length=50, default='basse') # Priorité par défaut "basse"
